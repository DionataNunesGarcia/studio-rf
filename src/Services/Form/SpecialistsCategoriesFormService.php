...
class SpecialistsCategoriesFormService extends DefaultService
{
    /**
    ...
    public function getListShowWebsite() :array
    {
        return $this->__table
            ->find()
            ->where([
                'SpecialistsCategories.status !=' => StatusEnum::EXCLUDED,
                'SpecialistsCategories.show_website' => true,
            ])
            ...
            ->group('SpecialistsCategories.id')
            ->toArray();
    }
}
