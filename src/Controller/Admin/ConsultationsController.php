...
use App\Services\Form\ConsultationsFormService;
 ...
 */
class ConsultationsController extends AdminController
{
    /**
     * @var ConsultationsFormService $_formService
     */
    private ConsultationsFormService $_formService;

    /**
     * @var ConsultationsManagerService $_managerService
     */
    private ConsultationsManagerService $_managerService;

    /**
     * @var ConsultationsDatatablesService
     */
    private ConsultationsDatatablesService $_datatableService;
    ...
    public function initialize(): void
    {
        ...
        $this->_formService = new ConsultationsFormService($this);
        $this->_managerService = new ConsultationsManagerService($this);
        $this->_datatableService = new ConsultationsDatatablesService($this);
    }
    ...
    {
        $response = $this->_datatableService->getResults(null, $onlyOwn);
    ...
    public function add()
    {
        ...
        if ($this->getRequest()->is('post')) {
            try {
                $response = $this->_managerService->saveEntity($this->getRequest()->getData());
    ...
    searchOwnersConsultation
    editOwnerConsultation
     * @return \Cake\Http\Response|null|void Renders view
     */
